...
function sidebarColor(e) {
    ...
    e.classList.contains("active")
        ...
        document.querySelector("#sidenavCard") &&
            ...
            ((i = document.querySelector("#sidenavCardIcon")).className = ""),
            i.classList.add(...t));
}
function sidebarType(e) {
    for (
        var t = e.parentElement.children,
            ...
            i = i.classList.contains("dark-version"),
            l = [],
            s = 0;
        s < t.length;
        s++
    ...
    e.classList.contains("active")
        ...
        : e.classList.add("active");
    for (
        var r, o, c, u = document.querySelector(".sidenav"), s = 0;
        s < l.length;
        s++
    )
        u.classList.remove(l[s]);
    if ((u.classList.add(a), "bg-transparent" == a || "bg-white" == a)) {
        var g = document.querySelectorAll(".sidenav .text-white");
        for (let f = 0; f < g.length; f++)
            g[f].classList.remove("text-white"),
                g[f].classList.add("text-dark");
    } else {
        var h = document.querySelectorAll(".sidenav .text-dark");
        for (let v = 0; v < h.length; v++)
            h[v].classList.add("text-white"),
                h[v].classList.remove("text-dark");
    }
    if ("bg-transparent" == a && i) {
        h = document.querySelectorAll(".navbar-brand .text-dark");
        for (let $ = 0; $ < h.length; $++)
            h[$].classList.add("text-white"),
                h[$].classList.remove("text-dark");
    }
    ("bg-transparent" == a || "bg-white" == a) && n
...
function navbarFixed(e) {
    ...
    let a = document.getElementById("navbarBlur");
...
function navbarBlurOnScroll(e) {
    ...
    let i = ["blur", "shadow-blur", "left-auto"],
        n = ["shadow-none"];
    function l() {
        t.classList.add(...i), t.classList.remove(...n), r("blur");
    }
    function s() {
        t.classList.remove(...i), t.classList.add(...n), r("transparent");
    }
    function r(e) {
    ...
    total.forEach(function (e, t) {
        var a = document.createElement("div"),
            ...
            n =
                ...
                e.querySelector(".nav-link.active").parentElement);
        if (n) {
            var l = Array.from(n.closest("ul").children),
                i = l.indexOf(n) + 1;
            let s = 0;
            if (e.classList.contains("flex-column")) {
                for (var r = 1; r <= l.indexOf(n); r++)
                    s += e.querySelector(
                        "li:nth-child(" + r + ")"
                    ).offsetHeight;
                (a.style.transform = "translate3d(0px," + s + "px, 0px)"),
                    (a.style.width =
                        e.querySelector("li:nth-child(" + i + ")").offsetWidth +
                        "px"),
                    (a.style.height = e.querySelector(
                        "li:nth-child(" + r + ")"
                    ).offsetHeight);
            } else {
                for (r = 1; r <= l.indexOf(n); r++)
                    s += e.querySelector("li:nth-child(" + r + ")").offsetWidth;
                (a.style.transform = "translate3d(" + s + "px, 0px, 0px)"),
                    (a.style.width =
                        e.querySelector("li:nth-child(" + i + ")").offsetWidth +
                        "px");
            }
        ...
        e.onmouseover = function (t) {
            ...
            if (i) {
                let n = Array.from(i.closest("ul").children),
                    l = n.indexOf(i) + 1;
                e.querySelector("li:nth-child(" + l + ") .nav-link").onclick =
                    function () {
                        a = e.querySelector(".moving-tab");
                        let t = 0;
                        if (e.classList.contains("flex-column")) {
                            for (var s = 1; s <= n.indexOf(i); s++)
                                t += e.querySelector(
                                    "li:nth-child(" + s + ")"
                                ).offsetHeight;
                            (a.style.transform =
                            ...
                            (a.style.transform =
                                ...
                                (a.style.width =
                                    e.querySelector("li:nth-child(" + l + ")")
                                        .offsetWidth + "px");
                        }
                    };
            }
    ...
    window.addEventListener("resize", function (e) {
        total.forEach(function (e, t) {
            ...
            (i.innerHTML = "-"),
                ...
                (a.style.padding = "0px"),
                (a.style.transition = ".5s ease");
            let n = e.querySelector(".nav-link.active").parentElement;
            if (n) {
                let l = Array.from(n.closest("ul").children);
                i = l.indexOf(n) + 1;
                let s = 0;
                if (e.classList.contains("flex-column")) {
                    for (var r = 1; r <= l.indexOf(n); r++)
                    ...
                    (a.style.transform = "translate3d(0px," + s + "px, 0px)"),
                        (a.style.width =
                            e.querySelector("li:nth-child(" + i + ")")
                                .offsetWidth + "px"),
                        (a.style.height = e.querySelector(
                            "li:nth-child(" + r + ")"
                        ).offsetHeight);
                ...
                ? total.forEach(function (e, t) {
                      if (!e.classList.contains("flex-column")) {
                          ...
                          let a =
                              ...
                              i = Array.from(a.closest("ul").children);
                          i.indexOf(a);
                          let n = 0;
                          for (var l = 1; l <= i.indexOf(a); l++)
                              n += e.querySelector(
                                  "li:nth-child(" + l + ")"
                              ).offsetHeight;
                          var s = document.querySelector(".moving-tab");
                          (s.style.width =
                              e.querySelector("li:nth-child(1)").offsetWidth +
                              "px"),
                              (s.style.transform =
                ...
                : total.forEach(function (e, t) {
                      if (e.classList.contains("on-resize")) {
                          ...
                          (r.style.transform =
                              ...
                              (r.style.width =
                                  e.querySelector("li:nth-child(" + n + ")")
                                      .offsetWidth + "px");
                      }
                  });
    }),
...
function darkMode(e) {
    let t = document.getElementsByTagName("body")[0],
        ...
        n = document.querySelectorAll("button:not(.btn) > .text-dark"),
        ...
        u = document.querySelectorAll("a.nav-link.text-white"),
    ...
    if (e.getAttribute("checked")) {
        for (t.classList.remove("dark-version"), x = 0; x < a.length; x++)
            a[x].classList.contains("light") &&
                (a[x].classList.add("dark"), a[x].classList.remove("light"));
        for (x = 0; x < i.length; x++)
            i[x].classList.contains("light") &&
                (i[x].classList.add("dark"), i[x].classList.remove("light"));
        for (x = 0; x < n.length; x++)
            n[x].classList.contains("text-white") &&
                (n[x].classList.remove("text-white"),
                n[x].classList.add("text-dark"));
        ...
        for (x = 0; x < g.length; x++)
            g[x].classList.contains("text-white") &&
                (g[x].classList.remove("text-white"),
                g[x].classList.remove("opacity-8"),
                g[x].classList.add("text-dark"));
        for (x = 0; x < h.length; x++)
            h[x].classList.contains("bg-gray-600") &&
                (h[x].classList.remove("bg-gray-600"),
                h[x].classList.add("bg-gray-100"));
        for (x = 0; x < b.length; x++)
            b[x].hasAttribute("fill") && b[x].setAttribute("fill", "#252f40");
        for (x = 0; x < $.length; x++)
            $[x].closest(".card.bg-gradient-dark") ||
                ($[x].classList.remove("text-white"),
                $[x].classList.add("text-dark"));
        for (x = 0; x < p.length; x++) p[x].classList.remove("border-dark");
        e.removeAttribute("checked");
    } else {
        ...
        for (var x = 0; x < i.length; x++)
            i[x].classList.contains("dark") &&
                (i[x].classList.remove("dark"), i[x].classList.add("light"));
        for (var x = 0; x < n.length; x++)
            n[x].classList.contains("text-dark") &&
                (n[x].classList.remove("text-dark"),
                n[x].classList.add("text-white"));
        ...
        for (var x = 0; x < c.length; x++)
            c[x].classList.contains("text-dark") &&
                (c[x].classList.remove("text-dark"),
                c[x].classList.add("text-white"));
        for (var x = 0; x < g.length; x++)
            g[x].classList.contains("text-secondary") &&
                (g[x].classList.remove("text-secondary"),
                g[x].classList.add("text-white"),
                g[x].classList.add("opacity-8"));
        for (var x = 0; x < f.length; x++)
            f[x].classList.contains("bg-gray-100") &&
                (f[x].classList.remove("bg-gray-100"),
                f[x].classList.add("bg-gray-600"));
        for (var x = 0; x < v.length; x++)
            v[x].classList.remove("text-dark"),
                v[x].classList.add("text-white");
        for (var x = 0; x < b.length; x++)
            b[x].hasAttribute("fill") && b[x].setAttribute("fill", "#fff");
        for (var x = 0; x < y.length; x++) y[x].classList.add("border-dark");
        e.setAttribute("checked", "true");
    }
}
function showError(e, t) {
    ((e = e.parentElement).className =
        "input-group input-group-outline mb-3 is-invalid is-filled"),
...
window.addEventListener("resize", navbarColorOnResize),
    ...
    window.addEventListener("load", function () {
        ...
        //     e.preventDefault(),
        //         checkRequired([t, a, i, n]),
        //         checkLength(t, 3, 15),
        //         checkLength(i, 6, 25),
        //         checkEmail(a),
        //         checkPasswordMatch(i, n);
        // });
    });
var material = {
            ...
            var e = document.getElementById("fullCalendar"),
                ...
                n = new FullCalendar.Calendar(e, {
                    ...
                    events: [
                        {
                            title: "All Day Event",
                            start: new Date(a, i, 1),
                            className: "event-default",
                        },
                        {
                            id: 999,
                            title: "Repeating Event",
                            start: new Date(a, i, t - 4, 6, 0),
                            allDay: !1,
                        ...
                        },
                        {
                            id: 999,
                            title: "Repeating Event",
                            start: new Date(a, i, t + 3, 6, 0),
                            allDay: !1,
                            className: "event-rose",
                        },
                        {
                            title: "Meeting",
                            start: new Date(a, i, t - 1, 10, 30),
                            allDay: !1,
                            className: "event-green",
                        },
                        {
                            title: "Lunch",
                            start: new Date(a, i, t + 7, 12, 0),
                            end: new Date(a, i, t + 7, 14, 0),
                            allDay: !1,
                            className: "event-red",
                        },
                        {
                            title: "Md-pro Launch",
                            start: new Date(a, i, t - 2, 12, 0),
                            allDay: !0,
                            className: "event-azure",
                        },
                        {
                            title: "Birthday Party",
                            start: new Date(a, i, t + 1, 19, 0),
                            end: new Date(a, i, t + 1, 22, 30),
                            allDay: !1,
                            className: "event-azure",
                        },
                        {
                            title: "Click for Creative Tim",
                            start: new Date(a, i, 21),
                            end: new Date(a, i, 22),
    ...
    initVectorMap: function () {
        am4core.ready(function () {
            ...
            (t.exclude = ["AQ"]),
                (t.useGeodata = !0),
                ((t = t.mapPolygons.template).tooltipText = "{name}"),
                (t.polygon.fillOpacity = 0.6),
                (t.states.create("hover").properties.fill =
                    e.colors.getIndex(0)),
                ((t = e.series.push(
                    new am4maps.MapImageSeries()
                )).mapImages.template.propertyFields.longitude = "longitude"),
                ...
                ((e = t.mapImages.template.createChild(
                    am4core.Circle
                )).radius = 3),
                ...
                e.events.on("inited", function (e) {
                    !(function e(t) {
                        ...
                        )).events.on("animationended", function (t) {
                            e(t.target.object);
                        });
                    })(e.target);
                }),
