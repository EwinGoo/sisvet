...
<body class="landing-page" data-mobile-nav-style="classic">
            ...
            <div class="container-fluid">
                <div class="col-auto col-lg-2 me-lg-0 me-auto">
                    <a class="navbar-brand" href="index.html">
                        <img src="images/logo-main.jpg" alt class="default-logo" />
                        <img src="images/logo-main.jpg" alt class="alt-logo" />
                        <img src="images/logo-main.jpg" alt class="mobile-logo" />
                    </a>
                </div>
    ...
    <section class="full-screen ipad-top-space-margin md-h-850px" data-parallax-background-ratio="0.8"
      ...
      ">
                ...
                <div class="col-xl-10 col-lg-12 position-relative z-index-2">
                    ...
                    <div>
                        <h2 class="maquina fw-500 ls-minus-1px mb-20px text-white w-80 xl-w-90 md-w-100 mx-auto mt-2">
                            ...
                            <!-- <span class="linea">Test de Orientación</span><br />
                <span class="linea">Vocacional</span><br />
                <span class="linea">CHASIDES</span><br /> -->
                        </h2>
                    </div>
                    <div class="fs-21 lh-32 lg-w-90 mx-auto az-text-banner w-65">
                        <!-- Se constituye un importante instrumento de autoevaluación
              personal, cuya finalidad es de facilitar la adecuada elección de
              una carrera universitaria. El test de Orientación Vocacional
              CHASIDE, denominado Prueba Movilizadora y/o Reflexiva, es una
              prueba internacional, que mide las aptitudes y habilidades y hace
              la clasificación de las áreas del conocimiento.<br />
              Para que efectúes una adecuada elección de la profesión que
              quieras tomar y no tengas complicaciones en el futuro, te
              sugerimos que realices el Test, que ponemos a tu disposición, el
              cual es un excelente instrumento de ayuda. -->
                    ...
                    <div class="mt-35px position-relative z-index-9">
                        ...
                        <a href="#demo"
                            ...
                            style="box-shadow: 0px 0px 12px 0px #ffa512 inset">
                            <span>
                                <span class="btn-double-text" data-text="Pre-built websites">Pre-built websites</span>
                            </span>
                        </a>
                    </div>
        ...
        <img width="300px" height="300px" src="images/upeaLogo.png"
