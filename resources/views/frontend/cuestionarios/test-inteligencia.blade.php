                                ...
                                <div class="step_content d-block pt-5 pb-2">
                                    ...
                                    <div class="question_title d-block justify-content-center">
                                        ...
                                        <h2 class="d-flex m-auto">
                                            ...
                                            <ol>
                                                <li>Lee cada una de las afirmaciones.</li>
                                                <li>Si expresan características fuertes en tu persona y te parece que la
                                                    afirmación es veraz entonces seleccione "VERDAD" y si no lo es,
                                                    seleccione "FALSO".</li>
                                        ...
                                        <div class="col-4">
                                            <label id="opt_1"
                                                ...
                                                <input for="opt_1" type="radio" class="required"
                                                    name="preguntas[{{ $item->id_inteligencia }}][{{ $item->id_pregunta }}]"
                                                    value="1">
                                            </label>
                                        </div>
                                        <div class="col-4">
