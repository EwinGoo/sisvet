...
class FPDF
{
	...
	function Header()
	{
		...
		$this->AddFont('Newton Italic', '', 'Newton Italic.php');
		$this->SetFont('edwardianscriptitc', '', 35);
		$this->SetY(15);
		$this->Cell(0, 0, utf8_decode('Universidad Pública de El Alto'), 0, 1, 'C');
		$this->SetFont('Newton Italic', '', 8);
		$this->Cell(0, 20, utf8_decode('Creada por Ley 2115 del 5 de Septiembre de 2000 y Autonoma por Ley 2556 de 12 de Noviembre de 2003'), 0, 1, 'C');
		$this->Image('assets/images/upea-logo.png', 10, 4, 30, 0);
		$this->Image('assets/images/utic.png', 175, 4, 30, 0);
	}
